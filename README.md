...
**SOMAN ORU CHAYA** is an interactive tea-making simulator where the player has to prepare a cup of tea according to Soman Chettan's exact requirements and then perform the sacred art of **Chaya Adi** using hand gestures.
...
Soman Chettan enters the tea shop and gives his tea requirements.

For example:

> **"Kadupam kutti. Madhuram kureche."**

The player has to remember these requirements and use them during preparation.

The requirements determine the target values for the tea's strength and sweetness.

---

### Stage 2 — Milk + Water

The player begins preparing the tea by adding the required amount of milk and water.
...
2. Move the boiler using their hand.
3. Position the boiler above the glass.
4. Pour the liquid into the glass.

The position of the boiler determines whether the liquid enters the glass correctly.

If the boiler is positioned incorrectly, some of the liquid is spilled.

This introduces accuracy as part of the gameplay.
...
* **More tea powder** results in stronger tea.
* **Less tea powder** results in weaker tea.
* **Too much sugar** makes the tea excessively sweet.
* **Too little sugar** makes it less sweet than requested.
...
* Sugar quantity
* Milk/water balance
* Amount of tea retained
* Chaya Adi performance
...
The player can use their hand to grab and move the virtual boiler.
